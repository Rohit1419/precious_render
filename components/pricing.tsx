...
import type { Pricing as PricingType } from "@/lib/sanity/types";
...
export default function Pricing({ data }: PricingProps) {
  ...
  const fallbackData = {
    ...
    sectionDescription: "Choose the plan that fits your business needs. All plans include responsive design, SEO optimization, and post-launch support.",
    plans: [
      {
